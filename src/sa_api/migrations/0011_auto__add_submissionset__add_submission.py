...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sa_api_submissionset', (
            ...
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(related_name='submission_sets', to=orm['sa_api.Place'])),
            ('submission_type', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('sa_api', ['SubmissionSet'])
        ...
        db.create_table('sa_api_submission', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', to=orm['sa_api.SubmissionSet'])),
        ))
        db.send_create_signal('sa_api', ['Submission'])
