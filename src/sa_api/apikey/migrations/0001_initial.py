...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('apikey_apikey_datasets', (
            ...
            ('dataset', models.ForeignKey(orm['sa_api.dataset'], null=False))
        ))
    ...
    models = {
        'apikey.apikey': {
            ...
            'datasets': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['sa_api.DataSet']", 'symmetrical': 'False', 'blank': 'True'}),
