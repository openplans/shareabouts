var InformationPanel = (function () {
  ...
  var init = function (config) {
    ...
    this.positionFor = function(element, smallScreen) {
      if (smallScreen) {
        this.popupTipWrapper.show();
        var bottom = this.options.mapContainer[0].offsetHeight - (element.offset().top - this.options.mapContainer.offset().top);
